...
#----------------------------------------------------------------------------------------
   ...
   def parse_cmdline_args( self ):
      ...
      svnurl          = '$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/PTCLM/trunk_tags/PTCLM2_170302/test/PTCLMtesting_prog.py $'
      versiongroup    = OptionGroup( parser, "Version Id: $Id: PTCLMtesting_prog.py 83568 2017-02-28 19:02:30Z erik $ URL: "+svnurl )
