module OrbitalValsMod
  ...
  !   Copied from shr_orb_mod from https://github.com/ESCOMP/CESM_share
  !
  !
  ...
  real(SHR_KIND_R8),    parameter :: pi = 3.14159265358979323846_SHR_KIND_R8
  ...
  integer(SHR_KIND_IN), parameter :: SHR_ORB_UNDEF_INT = 2000000000         ! undefined int
  real(SHR_KIND_R8),    parameter :: SHR_ORB_UNDEF_REAL = 1.e36_SHR_KIND_R8 ! undefined real

  contains

    subroutine get_orbital_vals(iyear_AD, s_logunit, eccen, mvelp, obliqr,     &
      lambm0, mvelpp)
      !
      ! Gets orbital values for a specific day
      !

      ! Data dictionary: calling arguments
      integer(SHR_KIND_IN), intent(in)  :: iyear_AD  ! Year to calculate orbit for
      integer,              intent(in)  :: s_logunit ! log file unit number
      real(SHR_KIND_R8),    intent(out) :: eccen    ! orbital eccentricity
      real(SHR_KIND_R8),    intent(out) :: mvelp    ! moving vernal equinox long
      real(SHR_KIND_R8),    intent(out) :: obliqr   ! Earths obliquity in rad
      real(SHR_KIND_R8),    intent(out) :: lambm0   ! Mean long of perihelion at vernal equinox (radians)
      real(SHR_KIND_R8),    intent(out) :: mvelpp   ! moving vernal equinox long of perihelion plus pi (rad)
    ...
    end subroutine get_orbital_vals

    !:.........................................................................:

    subroutine shr_orb_params(iyear_AD, eccen, obliq, mvelp,                   &
      obliqr, lambm0, mvelpp, s_logunit)
    ...
    subroutine shr_orb_decl(calday, eccen, mvelpp, lambm0, obliqr, delta, eccf)
      ...
      real(SHR_KIND_R8), intent(in)  :: lambm0 ! Mean long of perihelion at the vernal equinox (radians)
      real(SHR_KIND_R8), intent(in)  :: mvelpp ! moving vernal equinox longitude of perihelion plus pi (radians)
      ...
      real(SHR_KIND_R8), parameter :: ve     = 80.5_SHR_KIND_R8  ! Calday of vernal equinox assumes Jan 1 = calday 1
      ...
      sinl  = sin(lmm)
      lamb  = lambm  + eccen*(2._SHR_KIND_R8*sinl +                            &
        eccen*(1.25_SHR_KIND_R8*sin(2._SHR_KIND_R8*lmm) +                      &
        eccen*((13.0_SHR_KIND_R8/12.0_SHR_KIND_R8)*                            &
        sin(3._SHR_KIND_R8*lmm) - 0.25_SHR_KIND_R8*sinl)))
      ...
      invrho = (1._SHR_KIND_R8 + eccen*cos(lamb - mvelpp))/                    &
        (1._SHR_KIND_R8 - eccen*eccen)
