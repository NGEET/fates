...
${FC} ${F_OPTS} -c -I bld/ -J./bld/ -o bld/libFatesJSONMod.so ${FATES_PATH}/main/FatesJSONMod.F90
${FC} ${F_OPTS} -I bld/ -J./bld/ -L./bld/ -lFatesConstantsMod -lFatesJSONMod -o test_json TestJSON.F90
