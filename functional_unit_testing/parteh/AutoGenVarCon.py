...
var_list0 = CheckFile('../../parteh/PRTLossFluxesMod.F90',check_str)

var_list0.extend(CheckFile('../../biogeochem/FatesAllometryMod.F90',check_str))
var_list0.extend(CheckFile('../../parteh/PRTAllometricCarbonMod.F90',check_str))
