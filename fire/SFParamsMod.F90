module SFParamsMod
   ...
   character(len=param_string_length),parameter :: SF_name_CWD_frac = "fates_fire_CWD_frac"
   character(len=param_string_length),parameter :: SF_name_max_decomp = "fates_fire_max_decomp"
