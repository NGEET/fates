module FatesIODimensionsMod
  ...
  private
    ...
    character(*), parameter, public  :: levedgebin = 'fates_levedgebin'! matches histFileMod
    ...
    ! levedgebin = This is a structure that records the boundaries for the
