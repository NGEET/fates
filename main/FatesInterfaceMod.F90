module FatesInterfaceMod
   ...
   type, public :: bc_out_type
      ...
      real(r8),allocatable :: qflx_ro_si               ! Water flux from runoff generated by
                                                       ! either plant hydraulics or dynamics
                                                       ! [mm H2O/s]
                                                       ! In hydraulics this is possible due to super-saturation
                                                       ! in dynamics this is possible due to the release of water
                                                       ! from plant death and litter drop
