module FatesUnitTestIOMod
  ...
  character(len=*) function full_file_path(filename)
  !
  ! DESCRIPTION:
  ! Obtain full path of file
  ! First check current working directory
  ! Then check full pathname on disk
  ...
  ! get local file name
  !full_file_path = 'file_path'!get_filename(filename)

  end function full_file_path
